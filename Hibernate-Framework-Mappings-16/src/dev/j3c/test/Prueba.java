...
public class Prueba {
	...
	public static void main(String[] args) {
		...
		try {
			...
			Estudiante estudiante = sesion.get(Estudiante.class, 2);
			
			System.out.println("Estudiante a eliminar: " + estudiante);
			
			//Eliminamos el estudiante -> Hibernate eliminara el estudiante, y en la tabla de relaciones se eliminaran
			//Todas las referencias a los cursos en los que estaba matriculado, pero no se eliminan estos cursos.
